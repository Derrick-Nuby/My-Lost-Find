...
<head>
    ...
    <title>Login | Create Account | MyLostFind.Com</title>
...
<body>
    ...
    <main>
        <!-- <h1 class="btitle">Login Or Create An Acount</h1> -->
        <div class="mainbox">
            <div class="choose">
                <div class="btnsc active" id="loginbtn">
                    Login
                </div>
                <div class="btnsc" id="createbtn">
                    Create Account
                </div>
            </div>
            <div class="login" id="login">
                <form action="">
                    ...
                    <div class="middle"><input type="submit" value="LogIn" id="submitButton"></div>
                </form>
            </div>
            ...
            <div class="create" id="create">
                <form action="">
                    ...
                    <input type="number">
                    <label for="">Email: </label>
                    <input type="email" name="mail" id="emailtest">
                    <label for="">Phone:</label>
                    <input type="number" name="numnerss" id="ofphone">
                    <label for="">Password:</label>
                    <input type="password">
                    <div class="middle"><input type="submit" value="Create Account"></div>
