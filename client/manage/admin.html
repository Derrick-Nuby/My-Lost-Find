    ...
    <main>
        ...
        <div class="notifications">
            ...
            <ol class="notitems">
                ...
                <li>12 New Lost Documents Declared <a href="./lostsubmissions.html">Check them</a></li>
                <li>3 New found items <a href="./foundsubmissions.html">check them</a></li>
                <li>12 contact messages <a href="./contactedpeople.html">check messages</a></li>
                <li>5 pages are slow <a href="./systemstatus.html">fix them</a></li>
            </ol>
        </div>
