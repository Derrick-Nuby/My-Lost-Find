...
<body>
    ...
    <main>
        ...
        <div class="sidebar" id="sidesection">
            ...
            <a href="" class="sidecontent"><span>➤</span> Home</a>
            <a href="" class="sidecontent">Lost Items</a>
            <a href="" class="sidecontent">Found Items</a>
            <a href="" class="sidecontent">Completed and Matched</a>
            <a href="" class="sidecontent">Notification</a>
            <a href="" class="sidecontent">Account Management</a>
            <a href="" class="sidecontent">Logout</a>
        </div>

        <h1 class="salutation"><span id="greeting">Hello</span> Samantha</h1>

        <div class="boxucont">
            <div>
                <h3>Add The Items You Have Lost</h3>
            <div class="boxu bou-1"><span>+</span></div>
            </div>
            <div>
                <h3>Add The Items You Have Found</h3>
            <div class="boxu bou-2"><span>+</span></div>
            </div>
        </div>
    </main>
