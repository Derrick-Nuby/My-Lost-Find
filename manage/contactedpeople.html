...
<body>
    ...
    <main>
        ...
        <div class="sidebar" id="sidesection">
            ...
            <a href="./admin.html" class="sidecontent">Home</a>
            ...
            <a href="./contactedpeople.html" class="sidecontent  activeside"><span>➤</span>Contacted People</a>
        ...
        <h1 class="salutation">People Who Contacted You</h1>


        <table id="tables">
            <tr>
                <th>No</th>
                <th width="170px">Names</th>
                <th width="170px">Cause</th>
                <th width="150px">Date</th>
                <th>Message</th>
            </tr>
            <tr>
                <td>1</td>
                <td>MUHANUZI Christian</td>
                <td>Fake Document</td>
                <td>2023-AUG-16</td>
                <td class="messagecontact">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Sequi officiis reprehenderit doloremque enim consequatur. Rem cupiditate magni optio enim aspernatur? Error, neque natus iusto quisquam  <a href="">view-more</a></td>
            </tr>
            <tr>
                <td>2</td>
                <td>MUHANUZI Christian</td>
