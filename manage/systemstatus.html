...
<body>
    ...
    <main>
        ...
        <div class="sidebar" id="sidesection">
            ...
            <a href="./systemstatus.html" class="sidecontent  activeside"><span>➤</span>System Status</a>
            <a href="../index.html" class="sidecontent">Logout</a>
        </div>
        <h1 class="salutation">Sytem Status</h1>

        <div class="notifications">
            <h2 class="notitle">Quick Notifications</h2>
            <ol class="notitems">
                <li>20 total pages</li>
                <li>240 new visitors</li>
                <li>7hrs visited</li>
                <li>2 malfunctioning pages</li>
            </ol>
        </div>
        ...
        <table id="tables">
            ...
            <tr>
                <td>1</td>
                <td><a href="https://mylostfind.com/recover
">https://mylostfind.com/recover
</a></td>
                <td>1</td>
                <td>1</td>
                <td>200</td>
