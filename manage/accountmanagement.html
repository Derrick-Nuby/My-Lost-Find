...
<body>
    ...
    <main>
        ...
        <div class="sidebar" id="sidesection">
            ...
            <a href="./accountmanagement.html" class="sidecontent activeside"><span>➤</span>Accounts &amp; Users</a>
            <a href="./systemstatus.html" class="sidecontent">System Status</a>
            <a href="../index.html" class="sidecontent">Logout</a>
        </div>
        <h1 class="salutation">Manage Accounts &amp; Users</h1>

        <table id="tables">
            <tr>
                <th>No</th>
                <th>Names</th>
                <th>Submitted-Found-Items</th>
                <th>Submitted-Lost-Items</th>
                <th>Matches</th>
                <th>Manage</th>
            </tr>
            <tr>
