...
<body>
    ...
    <main>
        ...
        <div class="sidebar" id="sidesection">
            ...
            <a href="./foundsubmissions.html" class="sidecontent  activeside"><span>➤</span>Submitted Found Items</a>
        ...
        <h1 class="salutation">all submitted Found items</h1>
